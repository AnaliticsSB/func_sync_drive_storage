...
def get_credentials():
    ...
    auth_creds = 'projects/709427406268/secrets/gcp_sb-xops-stage/versions/latest'
...
def initialize_service_drive():
    client = secretmanager.SecretManagerServiceClient()
    secrets = 'projects/709427406268/secrets/gcp_sb-prototipos-xops/versions/latest'
...
def process_pdfs(*args, **kwargs):
    ...
    try:
      ...
      return summary, 200
        ...
        error_message = f"Error crítico en el proceso: {e}"
        print(error_message)
